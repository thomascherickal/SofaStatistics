...
# LOCAL_PATH = '/home/g/different_sofastats_location' # can override but make sure the new folder doesn't exist yet - let SOFA make and populate it. Only then override anything you want to override.
