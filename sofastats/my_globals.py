...
SPEARMANS_INIT_TBL = u"Spearmans initial table"
SPEARMANS_X_RANKED = u"Spearmans sample X sorted vals and ranks"
SPEARMANS_Y_RANKED = u"Spearmans sample Y sorted vals and ranks"
SPEARMANS_N = u"Spearmans N"
SPEARMANS_N_CUBED_MINUS_N = u"Spearmans N cubed minus N"
SPEARMANS_TOT_D_SQUARED = u"Spearmans total diff squared"
SPEARMANS_TOT_D_SQUARED_x_6 = u"Spearmans total diff squared times 6"
SPEARMANS_PRE_RHO = u"Spearmans pre-rho"
SPEARMANS_RHO = u"Spearmans rho"
CHI_GRAND_TOT = u"Chi Square grand total"
CHI_CELLS_DATA = u"Chi Square cells data"
CHI_OBSERVED = u"Chi Square observed"
CHI_ROW_N = u"Chi Square row n"
CHI_COL_N = u"Chi Square column n"
CHI_CELL_ROW_SUM = u"Chi Square cell row sum"  ## sum pertaining to row cell belongs to (shared with all other cells in row)
CHI_CELL_COL_SUM = u"Chi Square cell column sum"
CHI_ROW_SUMS = u"Chi Square row sums"
CHI_ROW_OBS = u"Chi Square row obs items"
CHI_COL_SUMS = u"Chi Square column sums"
CHI_COL_OBS = u"Chi Square column obs items"
CHI_EXPECTED = u"Chi Square expected"
CHI_MAX_OBS_EXP = u"Chi Square max of obs and exp"
CHI_MIN_OBS_EXP = u"Chi Square min of obs and exp"
CHI_DIFF = u"Chi Square diff"
CHI_DIFF_SQU = u"Chi Square diff squared"
CHI_PRE_CHI = u"Chi Square pre-Chi"
CHI_PRE_CHIS = u"Chi Square pre-Chis"  ## list of them
CHI_CHI_SQU = u"Chi Square actual Chi Squared value"
CHI_ROW_N_MINUS_1 = u"Chi Square row N - 1"
CHI_COL_N_MINUS_1 = u"Chi Square column N - 1"
CHI_DF = u"CHI Square degrees of freedom"
# core stats *********************************************************
...
GOOGLE_DOWNLOAD = "temporary_google_spreadsheet.%s" % GOOGLE_DOWNLOAD_EXT
LINUX = "linux"
WINDOWS = "windows"
MAC = "mac"
...
CHART_BOXPLOT_LWHISKER_ROUNDED = u"lwhisker_rounded"
CHART_BOXPLOT_LBOX = u"lbox"
CHART_BOXPLOT_LBOX_ROUNDED = u"lbox_rounded"
CHART_BOXPLOT_MEDIAN = u"median"
CHART_BOXPLOT_MEDIAN_ROUNDED = u"median_rounded"
CHART_BOXPLOT_UBOX = u"ubox"
CHART_BOXPLOT_UBOX_ROUNDED = u"ubox_rounded"
CHART_BOXPLOT_UWHISKER = u"uwhisker"
CHART_BOXPLOT_UWHISKER_ROUNDED = u"uwhisker_rounded"
CHART_BOXPLOT_OUTLIERS = u"outliers"
CHART_BOXPLOT_OUTLIERS_ROUNDED = u"outliers_rounded"
