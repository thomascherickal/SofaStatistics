...
## to avoid using dist-package version if installed as well - /usr/local/lib/python2.7/dist-packages/sofastats-1.5.0-py2.7.egg - and to enable sofastats namespacing
import os
import sys
