...
def set_data_con_gui(parent, scroll, szr, lblfont, *, read_only=False):
    ...
    parent.txt_msaccess_default_db = wx.TextCtrl(
    ...
    ## default table
    parent.lbl_msaccess_default_tbl = wx.StaticText(
    ...
    parent.txt_msaccess_default_tbl = wx.TextCtrl(
    ...
    szr_msaccess_inner.Add(
        parent.lbl_msaccess_default_db, 0, wx.LEFT|wx.RIGHT, 5)
    szr_msaccess_inner.Add(
        parent.txt_msaccess_default_db, 1, wx.GROW|wx.RIGHT, 10)
    szr_msaccess_inner.Add(
        parent.lbl_msaccess_default_tbl, 0, wx.LEFT|wx.RIGHT, 5)
    szr_msaccess_inner.Add(
        parent.txt_msaccess_default_tbl, 1, wx.GROW|wx.RIGHT, 10)
    ...
    parent.msaccess_grid = settings_grid.SettingsEntry(
        frame=parent, panel=scroll, grid_size=(900, 100),
...
def process_con_dets(parent, default_dbs, default_tbls, con_dets):
    ...
    if parent.msaccess_grid.new_is_dirty:
        ...
        wx.MessageBox(
            _("The MS Access details on the new row have not been saved. "
