...
class DlgPrefs(wx.Dialog):
    def __init__(self, parent, prefs_dic_in):
        ...
        :param dict prefs_dic_in: expects a dict, even an empty one. If empty,
         or with wrong keys, starts fresh and will store what gets selected here
         if user applies changes.
        """
