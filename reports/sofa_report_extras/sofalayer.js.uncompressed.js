...
(function(){
	...
	dojo.declare("dojox.charting.action2d.Tooltip", dojox.charting.action2d.Base, {
		...
		process: function(o){
			...
			showChartingTooltip(this.text(o), this.aroundRect, position, "center", this.tooltipBorderColour);
		}
	});
	...
	var MasterTooltip = dojo.declare(dijit._MasterTooltip, {
		...
		show: function(/*String*/ innerHTML, /*DomNode*/ aroundNode, /*String[]?*/ position, /*String*/alignment, /*String*/tooltipBorderColour){ // modification of existing line
    ...
    function showChartingTooltip(innerHTML, aroundNode, position, alignment, tooltipBorderColour){ // modification of existing line

		if(!masterTT){ masterTT = new MasterTooltip(); }
		return masterTT.show(innerHTML, aroundNode, position, alignment, tooltipBorderColour); // modification of existing line
	}
