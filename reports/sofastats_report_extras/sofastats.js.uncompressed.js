	       ...
	       render: function(dim, offsets){
		        ...
		        for(var i = this.series.length - 1; i >= 0; --i){
			        ...
			        var lw, lq, med, uq, uw, outliers;
			            lw = run.summary_data.lwhisker;
			            lq = run.summary_data.lbox;
			            med = run.summary_data.median;
			            uq = run.summary_data.ubox;
			            uw = run.summary_data.uwhisker;
			            outliers = run.summary_data.outliers;
			        ...
			        var rect = {x: center - width / 2,
				        ...
				        var o = {
				            ...
				            x:       indiv_boxlbl + " [" + lq + ", " + uq + "]",
				            y:       indiv_boxlbl + " [" + lq + ", " + uq + "]"
				        };
				        this._connectEvents(o);
				        o = {
				            element: "column",
